...
import static project.recyclerview.lym.org.recyclerviewlibrary.adapter.BaseFastAdapter.EMPTY_VIEW;
import static project.recyclerview.lym.org.recyclerviewlibrary.adapter.BaseFastAdapter.FOOTER_VIEW;
import static project.recyclerview.lym.org.recyclerviewlibrary.adapter.BaseFastAdapter.HEADER_VIEW;
import static project.recyclerview.lym.org.recyclerviewlibrary.adapter.BaseFastAdapter.LOADING_VIEW;
...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    protected BaseFastAdapter baseQuickAdapter;
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (BaseFastAdapter) recyclerView.getAdapter();
...
//                mPressedView.setPressed(true);
     ...
     */
    public abstract void onItemClick(BaseFastAdapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(BaseFastAdapter adapter, View view, int position);

    public abstract void onItemChildClick(BaseFastAdapter adapter, View view, int position);

    public abstract void onItemChildLongClick(BaseFastAdapter adapter, View view, int position);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        if (baseQuickAdapter==null){
            if (recyclerView!=null){
                baseQuickAdapter= (BaseFastAdapter) recyclerView.getAdapter();
            }else {
                return false;
            }
        }
