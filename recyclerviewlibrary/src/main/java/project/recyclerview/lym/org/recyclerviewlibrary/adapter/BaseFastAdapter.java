...
import project.recyclerview.lym.org.recyclerviewlibrary.BaseAnimation.BaseAnimation;
import project.recyclerview.lym.org.recyclerviewlibrary.BaseAnimation.ScaleInAnimation;
import project.recyclerview.lym.org.recyclerviewlibrary.BaseAnimation.SlideInBottomAnimation;
...
/**
 * 基类Adapter，可添加头布局，也可添加尾布局，下拉刷新，以及加载更多
 *
 * @author yaoming.li
 */
public abstract class BaseFastAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    protected static final String TAG = BaseFastAdapter.class.getSimpleName();
     ...
     */
    public BaseFastAdapter(int layoutResId, List<T> data) {
    ...
    public BaseFastAdapter(List<T> data) {
        this(0, data);
    }

    public BaseFastAdapter(int layoutResId) {
    ...
    private RecyclerView.OnScrollListener listener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            if (!mLoading && isLastItemPosition && newState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
                if (mRequestLoadMoreListener != null) {
                    mLoading = true;
