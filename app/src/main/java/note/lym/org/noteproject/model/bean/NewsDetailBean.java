...
public class NewsDetailBean {
    ...
    private List<NewsList.NewsBean> relative_sys;
    ...
    public List<NewsList.NewsBean> getRelative_sys() {
        return relative_sys;
    }

    public void setRelative_sys(List<NewsList.NewsBean> relative_sys) {
