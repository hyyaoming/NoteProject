package note.lym.org.noteproject.view.likeview;
 ...
 *
 * @author yaoming.li
 * @since 2017年7月6日16:35:31
 */

public class LikeView extends View {
    private static final int ANIMATE_DURATION = 1800;
     ...
     * 心形默认颜色
     */
    private static final int CLICKED_COLOR = 0xffe53a42;
    /**
     * 环绕圆点的颜色
     */
    ...
    private void drawDotWithRing(Canvas canvas, int radius, int color) {
        ...
        drawHeart(canvas, mCurrentRadius, CLICKED_COLOR);
    }
    ...
    private void drawDot(Canvas canvas) {
        ...
        dotRL = (dotR * (1 - mCurrentPercent) * 4) > dotR ? dotR :(dotR * (1 - mCurrentPercent) * 3);
        for (int i = 0; i < 7; i++) {
    ...
    private void deselectLike() {
        ...
        mCurrentState = HEART_VIEW;
        state = false;
        AnimateHelper.doLike(this, ANIMATE_DURATION);
        invalidate();
    }
