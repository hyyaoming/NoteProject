...
public class AnimateHelper {
     ...
     * @param duration  时间
     */
    public static void doLike(View view,int duration){
        AnimatorSet set = new AnimatorSet();
        Animator animatorX = ObjectAnimator.ofFloat(view,"scaleY",1,1,1.2f,1);
        Animator animatorY = ObjectAnimator.ofFloat(view,"scaleX",1,1,1.2f,1);
